...
import java.util.Scanner;
    ...
    public class Main extends Thread {
        ...
        public String kullaniciBilgileriniAl() {
            ...
            String kullaniciAdi, parola, email;

            System.out.println("Kullanıcı Adı giriniz: ");
            kullaniciAdi = klavye.nextLine();

            System.out.println("Parola giriniz: ");
            parola = klavye.nextLine();

            System.out.println("E-posta giriniz: ");
            email = klavye.nextLine();

            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("Kullanıcı Adı: ").append(kullaniciAdi).append("\n");
            stringBuilder.append("Parola: ").append(parola).append("\n");
